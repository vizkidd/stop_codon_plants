...
data.aa.aln<-AlignSeqs(translate(data.dna, genetic.code=GENETIC_CODE, no.init.codon=FALSE,if.fuzzy.codon="solve"),iterations=0,refinements=0)
writeXStringSet(data.aa.aln,filepath = aa_aln_file,format = "fasta")
